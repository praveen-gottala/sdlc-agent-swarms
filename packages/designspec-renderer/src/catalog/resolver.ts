...
export function resolveNode(nodeId: string, node: NodeSpec, catalog: CatalogMap): ResolvedNode {
  ...
  if (node.type) {
    return {
      ...
      helper: (node.overrides?.helper as string | undefined),
      title: (node.overrides?.title as string | undefined),
      ...
      shadow: node.shadow,
      radius: node.radius,
      textAlign: (node.overrides?.textAlign as 'left' | 'center' | 'right' | undefined),
  ...
  return {
    ...
    value: node.value,
    placeholder: node.placeholder,
    helper: (overrides.helper as string | undefined),
    ...
    textAlign: (overrides.textAlign as 'left' | 'center' | 'right' | undefined) ?? (overrides.text_align as 'left' | 'center' | 'right' | undefined),
