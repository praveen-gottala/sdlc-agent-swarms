/**
 * @module @agentforge/core/design/design-tokens-defaults
 *
...
import type { OpacitySpec, MotionSpec, StateTokensSpec, ElevationSpec, TypographyScaleEntry } from '../types/design-system.js';
