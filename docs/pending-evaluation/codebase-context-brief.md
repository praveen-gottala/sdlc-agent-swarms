...
> - **What it contains:** V2 foundation overview, existing agents.yaml layout, 12 notes on existing infrastructure
> - **Why flagged:** Reads like a session-briefing doc for onboarding Claude Code, not living documentation. Duplicates architecture.md.
