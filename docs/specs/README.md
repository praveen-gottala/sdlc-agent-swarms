...
Product requirements and specifications. `PRD.md` is the index and single entry
point — it links to domain specs that cover specific areas of the product.
Git history tracks all revisions; no version-numbered copies are kept.

| File | Scope |
|---|---|
| `PRD.md` | Index, executive summary, personas, problem statement |
