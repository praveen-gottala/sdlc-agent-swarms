...
docs/vision.md is the architectural vision. It covers fifteen
layers of the system, with locked and open decisions flagged. When
PRD.md and VISION.md conflict on an architectural question,
VISION.md wins. Before making any architectural decision,
check the relevant layer in the vision document.
