...
shape.strokes = [{ strokeColor: '#E5E7EB', strokeOpacity: 1, strokeWidth: 1, strokeAlignment: 'inner' }]; // token: border-default
// Level 2 — elevated (shadow-md), e.g. selected state
shape.strokes = [{ strokeColor: '#2563EB', strokeOpacity: 1, strokeWidth: 2, strokeAlignment: 'inner' }]; // token: cta-primary
// Level 3 — overlay (shadow-lg)
shape.strokes = [{ strokeColor: '#94A3B8', strokeOpacity: 1, strokeWidth: 2, strokeAlignment: 'inner' }]; // darker border for overlay depth
```
