...
const PRESETS: readonly ComponentLibraryPreset[] = [
  {
    ...
    reactMappings: {
      button: { import_path: '@/components/ui/button', component_name: 'Button', variant_prop: 'variant', size_prop: 'size' },
      card: { import_path: '@/components/ui/card', component_name: 'Card' },
      input: { import_path: '@/components/ui/input', component_name: 'Input' },
      badge: { import_path: '@/components/ui/badge', component_name: 'Badge', variant_prop: 'variant', size_prop: 'size' },
      tabs: { import_path: '@/components/ui/tabs', component_name: 'Tabs' },
      avatar: { import_path: '@/components/ui/avatar', component_name: 'Avatar', size_prop: 'size' },
  ...
  },
  {
    ...
    reactMappings: {
      button: { import_path: '@mui/material/Button', component_name: 'Button', variant_prop: 'variant', size_prop: 'size' },
      ...
      badge: { import_path: '@mui/material/Chip', component_name: 'Chip', variant_prop: 'variant', size_prop: 'size' },
      tabs: { import_path: '@mui/material/Tabs', component_name: 'Tabs' },
      avatar: { import_path: '@mui/material/Avatar', component_name: 'Avatar', size_prop: 'size' },
  ...
  },
  {
    ...
    reactMappings: {
      button: { import_path: '@chakra-ui/react', component_name: 'Button', variant_prop: 'variant', size_prop: 'size' },
      ...
      badge: { import_path: '@chakra-ui/react', component_name: 'Badge', variant_prop: 'variant', size_prop: 'size' },
      tabs: { import_path: '@chakra-ui/react', component_name: 'Tabs', variant_prop: 'variant' },
      avatar: { import_path: '@chakra-ui/react', component_name: 'Avatar', size_prop: 'size' },
  ...
  },
  {
    ...
    reactMappings: {
      button: { import_path: 'antd', component_name: 'Button', variant_prop: 'type', size_prop: 'size' },
      card: { import_path: 'antd', component_name: 'Card' },
      input: { import_path: 'antd', component_name: 'Input' },
      badge: { import_path: 'antd', component_name: 'Tag', size_prop: 'size' },
      tabs: { import_path: 'antd', component_name: 'Tabs' },
      avatar: { import_path: 'antd', component_name: 'Avatar', size_prop: 'size' },
  ...
  },
  {
    ...
    reactMappings: {
      button: { import_path: '@radix-ui/themes', component_name: 'Button', variant_prop: 'variant', size_prop: 'size' },
      card: { import_path: '@radix-ui/themes', component_name: 'Card' },
      input: { import_path: '@radix-ui/themes', component_name: 'TextField.Root' },
      badge: { import_path: '@radix-ui/themes', component_name: 'Badge', variant_prop: 'variant', size_prop: 'size' },
      tabs: { import_path: '@radix-ui/themes', component_name: 'Tabs.Root' },
      avatar: { import_path: '@radix-ui/themes', component_name: 'Avatar', size_prop: 'size' },
  ...
  },
  {
    ...
    reactMappings: {
      button: { import_path: '@mantine/core', component_name: 'Button', variant_prop: 'variant', size_prop: 'size' },
      card: { import_path: '@mantine/core', component_name: 'Card' },
      input: { import_path: '@mantine/core', component_name: 'TextInput' },
      badge: { import_path: '@mantine/core', component_name: 'Badge', variant_prop: 'variant', size_prop: 'size' },
      tabs: { import_path: '@mantine/core', component_name: 'Tabs' },
      avatar: { import_path: '@mantine/core', component_name: 'Avatar', size_prop: 'size' },
