...
interface CostsData {
  ...
  budgetLimits?: {
    perPhaseMaxUsd: number | null;
    perTaskMaxUsd: number | null;
  };
...
export default function CostsPage() {
  ...
  const perPhaseBudget = costsData.budgetLimits?.perPhaseMaxUsd ?? null;
  const perTaskBudget = costsData.budgetLimits?.perTaskMaxUsd ?? null;
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex gap-4">
        ...
        <BudgetCard label="Phase Budget (Code Gen)" spent={codeGenCost} limit={perPhaseBudget ?? 0} />
        <BudgetCard label="Per-Task Limit" spent={maxTaskCost} limit={perTaskBudget ?? 0} />
      </div>
