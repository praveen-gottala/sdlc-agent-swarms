...
Use this example ONLY when the user message specifies a mobile viewport width (≤ 480px). For desktop-only projects, use the Dashboard or Form examples above.
...
- Use the **Viewport Width** from the user message. If no viewport width is specified, default to **1440px**.
...
- For viewports ≤ 768px, use single-column layouts. For viewports ≥ 1024px, multi-column layouts are appropriate. Only apply this if the viewport width from the user message is in the narrow range.
