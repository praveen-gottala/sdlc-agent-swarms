/**
 * @module @agentforge/core/design/tailwind-generator
 *
 * Generates tailwind.config.ts and globals.css from DesignTokensSpec.
 * Uses shadcn conventions for CSS custom properties (HSL channels).
 */

import type { DesignTokensSpec } from '../types/design-system.js';
...
/** Generate globals.css with shadcn CSS custom properties. */
