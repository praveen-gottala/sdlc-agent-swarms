...
| 3 | Agent taxonomy | 1 of 4 | Clarifier is the only implemented spine stage (9 nodes). Architect, Implementer, and Reviewer are specified in [vision.md](../vision.md) but have no code. |
